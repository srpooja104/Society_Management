...
const EditOtherIncomeModal = ({ onClose, incomeData }) => {
    return (
        <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center">
            <div className="bg-white p-6 rounded-lg w-full max-w-md">
                <h2 className="text-xl font-bold mb-4">Edit Other Income</h2>
                    ...
                    <div className="flex gap-4 mb-4">
                        ...
                        <div className="w-1/2">
                            ...
                            <input 
                                type="date" 
                                className="w-full border rounded px-3 py-2" 
                                defaultValue={incomeData?.dueDate || ''} 
                            />
                        </div>
                    </div>
                    <div className="mb-4">
...
export default EditOtherIncomeModal;
