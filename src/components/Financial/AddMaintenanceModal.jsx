          ...
          <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div className="sm:flex sm:items-start">
              <div className="mt-3 text-center sm:mt-0 sm:text-left w-full">
                <h3 className="text-xl leading-6 font-medium text-black mb-4">Add Maintenance Detail</h3>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="relative">
                        <DatePicker
                            ...
                            className="w-full border border-gray-300 rounded-lg px-4 py-2 text-gray-700 outline-none pr-10"
                            placeholderText="Select date"
                            ref={datePickerRef}
                        />
                        
                        {/* Calendar icon inside the input box, on the right */}
                        <FaCalendarAlt 
